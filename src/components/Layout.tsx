...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f8f9fa] text-gray-900 dark:bg-[#0a0d14] dark:text-gray-100 transition-colors duration-200">
      ...
      <section className="bg-[#1B4332] py-16 sm:py-20 md:py-24 transition-colors duration-200">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            to="/documents"
            className="inline-flex items-center justify-center px-6 py-3 border border-white text-white text-sm font-medium rounded-lg hover:bg-white hover:text-[#1B4332] transition-colors duration-200"
          >
            Read the documents
          </Link>
        </div>
